...
public final class Const {
    ...
    public static class Wx {
        // 陈亚如
        public static final String appId = "wxd1dd2e2f49727492";
        public static final String appSecret = "your_app_secret";
    ...
    public static class TxyunSms {
        ...
        public static final String appKey = "your_app_key";
    ...
    public static class PayJS {
        ...
        public static final String key = "your_key"; // 通信秘钥
